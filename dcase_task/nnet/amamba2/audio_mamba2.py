...
from .mamba2_utils import VMamba2Block
...
def get_num_patches(height=64, width=1001, patch_height=64, patch_width=4):
...
def FrameASMModel(patch_h=64, patch_w=4, amamba2_dropout=0.1, **kwargs):
    return FrameASM(
        patch_h=patch_h,
        patch_w=patch_w,
        embed_dim=768,
