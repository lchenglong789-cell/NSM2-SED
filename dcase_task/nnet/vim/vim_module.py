...
def FrameVimModel(patch_h=64, patch_w=4, vim_dropout=0.1, **kwargs):
    return FrameVim(
        patch_h=patch_h,
        patch_w=patch_w,
        embed_dim=768,
        ...
        drop_path_rate=vim_dropout,
        drop_rate=vim_dropout,
        **kwargs)
