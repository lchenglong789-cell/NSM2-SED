...
from .m2_util import Mamba2Block
...
def FrameM2Model(patch_h=64, patch_w=4, mamba2_dropout=0.1, **kwargs):
    return FrameM2(
        patch_h=patch_h,
        patch_w=patch_w,
        embed_dim=768,
        ...
        drop_path_rate=mamba2_dropout,
        drop_rate=mamba2_dropout,
        **kwargs)
