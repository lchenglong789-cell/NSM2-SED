...
# path = sys.argv[1]
dub_path = "/data/AudioSet/audioset/manifest_ub/"
db_path = "/data/AudioSet/audioset/manifest_b/"

from torch.utils.data import ConcatDataset

dub = datasets.LMDBDataset(dub_path, "train", subset=None, transform=Transform(), return_key=True)
db = datasets.LMDBDataset(db_path, "train", subset=None, transform=Transform(), return_key=True)
...
torch.save(save_dict, "weights_labels.pt")
