...
from audiotrain.utils.common import cosine_scheduler_epoch, get_params_groups
from audiotrain.modules.head import LinearHead
from audiotrain.mambas.common import Normalize, MinMax, RandomCrop, Identity, CentralCrop
...
class DistillAMamba2EvalTransform:
    def __init__(self, sr=16000, max_len=12, n_mels=64):
        melspec_t = torchaudio.transforms.MelSpectrogram(
            sr, f_min=60, f_max=7800, hop_length=160, win_length=1024, n_fft=1024, n_mels=n_mels)
        to_db = torchaudio.transforms.AmplitudeToDB(stype="power", top_db=80)
