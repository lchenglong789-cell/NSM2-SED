...
from audiotrain.methods.frame.model import FrameAMamba2LightningModule
from audiotrain.methods.frame.downstream import utils
from audiotrain.methods.frame.downstream.data import collate_fn
from audiotrain.methods.frame.downstream.model import FineTuningPLModule, PretrainedEncoderPLModule
from audiotrain.methods.frame.downstream.mamba2 import FreezingTransform, FinetuneTargetTransform, FinetuneTrainTransform, FinetuneEvalTransform, FinetuneTargetTransformAudioset
...
def get_pretraied_encoder(args):
    ...
    pretrained_model = FrameAMamba2LightningModule.load_from_checkpoint(
...
def run(args, pretrained_module, fold=None):
    ...
    if args.dataset_name == "audioset":
        s = torch.load(os.path.join("/home/02363-2/SED/audiotrain/audiotrain/methods/frame/downstream/weights_labels.pt"), map_location="cpu")
