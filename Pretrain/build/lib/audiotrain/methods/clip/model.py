...
from audiotrain.models.amamba2 import AMamba2
from audiotrain.utils.common import cosine_scheduler_step, get_params_groups


class AMamba2LightningModule(LightningModule):
    def __init__(self,
                 arch="small",
    ...
    def add_model_specific_args(parent_parser):
        parser = parent_parser.add_argument_group("AMamba2Model")
