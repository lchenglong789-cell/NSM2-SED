...
from mamba2 import TrainAMamba2


class AMamba2DataModule(LightningDataModule):
    def __init__(self,
                 data_path=None,
        ...
        self.dataset = LMDBDataset(data_path,
                                   split="train",
                                   subset=subset,
                                   transform=TrainAMamba2(anchor_len=(train_len, train_len)))
    ...
    def add_data_specific_args(parent_parser):
        parser = parent_parser.add_argument_group("AMamba2Data")
