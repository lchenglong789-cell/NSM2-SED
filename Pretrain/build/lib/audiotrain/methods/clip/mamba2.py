...
class TrainAMamba2:
    def __init__(self, sr=16000, mask_ratio=0.75, different_positive=True, anchor_len=(6., 6.), positive_len=(6., 6.),
                 virtual_crop=1.5):
        ...
        self.mel_feature = transforms.Compose([melspec_t, to_db, normalize])
        self.positivecrop = transforms.Compose([RandomCrop(16000 * 6), self.mel_feature])

        self.positive_transform1 = transforms.Compose([Mixup(), RandomResizeCrop((1, virtual_crop)), ])
        self.positive_transform2 = transforms.Compose([Mixup(), RandomResizeCrop((1, virtual_crop)), ])
