...
from audiotrain.methods.clip.downstream.model import LinearClassifierPLModule, PretrainedEncoderPLModule
from auidotrain.methods.clip.downstream.mamba import FreezingMamba
from auidotrain.models.amamba2 import audio_mamba2


class PretrainedAMamba2EncoderPLModule(LightningModule):
    def __init__(self,
                 ckpt_path,
                 chunk_len: float,
                 n_blocks: int):
