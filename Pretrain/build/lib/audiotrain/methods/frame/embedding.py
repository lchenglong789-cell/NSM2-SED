...
def load_model(model_path):
    ...
    s = torch.load(model_path)
    pretrained_model = FrameAMamba2LightningModule.load_from_checkpoint(model_path)
...
def get_scene_embedding(audio, model):
    ...
    args:
        ...
        models: the pretrained encoder returned by load_model
    return:
        emb: retured embedding in the shape of [1,N_BLOCKS*emb_size] or [B,N_BLOCKS*emb_size], where emb_size is 768 for base models and 384 for small models.
...
def get_timestamp_embedding(audio, model):
    ...
    args:
        ...
        models: the pretrained encoder returned by load_model
    return:
        emb: retured embedding in the shape of [1,T,N_BLOCKS*emb_size] or [B,T,N_BLOCKS,emb_size], where emb_size is 768 for base models and 384 for small models.
