...
from mamba2 import FrameAMamba2TrainTransform
...
class FrameAMamba2DataModule(LightningDataModule):
    def __init__(self,
                 data_path=None,
        ...
        dataset_ub = LMDBDataset(data_path,
                                 split="train",
                                 subset=subset,
                                 transform=FrameAMamba2TrainTransform(
    ...
    def add_data_specific_args(parent_parser):
        parser = parent_parser.add_argument_group("FrameAMamba2Data")
        ...
        parser.add_argument('--aug_tea', default=True, type=bool_flag,
                            help='whether to augment the view fed into teacher branch; if symmetric is True, this augmented view is fed into both teacher and student.')
        parser.add_argument('--aug_stu', default=True, type=bool_flag,
                            help='whether to augment the view fed into teacher branch; if symmetric is True, this augmented view is fed into both teacher and student.')
