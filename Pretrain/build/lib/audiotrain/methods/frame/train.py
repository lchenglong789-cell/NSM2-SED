...
from model import FrameAMamba2LightningModule
from data import FrameAMamba2DataModule
...
def main(args):
    ...
    model = FrameAMamba2LightningModule(**dict_args)
    data = FrameAMamba2DataModule(**dict_args)
...
if __name__ == "__main__":
    parser = ArgumentParser("FrameAMamba2")
    ...
    parser = FrameAMamba2LightningModule.add_model_specific_args(parser)
    parser = FrameAMamba2DataModule.add_data_specific_args(parser)
