...
from audiotrain.datasets import register_dataset
...
def DCASEDataset(conf_file, split, transform=None, target_transform=None, unsup=False):
    ...
    if split == "test":
        ...
        train_sampler = ConcatDatasetSampler(tot_train_data, config["training"]["batch_size"], shuffle=True,
                                             mode=config["training"]["batch_len_index"], drop_last=True)
