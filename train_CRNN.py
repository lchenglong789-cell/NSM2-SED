...
from local.CRNN_trainer import SEDTask4
...
def prepare_run(argv=None):
    ...
    parser.add_argument(
        "--conf_file",
        default="/home/02363-2/SED/again/TLstudy/confs/CRNN_train.yaml",
        help="The configuration file with all the experiment parameters.",
    )
    parser.add_argument(
        "--log_dir",
        default="/data/LCL/workplace/new90/mamba_sed/pre_stage1/",
