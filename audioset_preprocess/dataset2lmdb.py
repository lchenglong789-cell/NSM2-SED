...
def dataset2lmdb(dataset, save_prefix, write_frequency=5000, max_num=3000000, num_workers=16):
    ...
    db = lmdb.open(lmdb_path, subdir=isdir,
                   map_size=1099511627776 * 5, readonly=False,
...
def folder2lmdb(dpath, split="train", lmdb_path=None, write_frequency=5000, max_num=3000000, num_workers=5):
    ...
    db = lmdb.open(lmdb_path, subdir=isdir,
                   map_size=1099511627776 * 23, readonly=False,
                   meminit=False, map_async=True)
